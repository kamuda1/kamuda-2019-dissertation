...
\begin{tabular}[c]{@{}c@{}}Background\\ Location \end{tabular} & \multicolumn{1}{c}{Chicago, Miami, Boston} \\ 
\end{tabular}
...
\multicolumn{1}{c}{Calibration - Linear} & 0.9 - 1.1 & Uniform \\ 
...
\multicolumn{1}{c}{Calibration - Offset (channels)} & 0 - 10 & Uniform \\ 
\multicolumn{1}{c}{Calibration - Linear} & 0.8 - 1.2 & Uniform \\ 
...
% \multicolumn{1}{c}{Input Scaling} & sqrt, sqrt-max, sqrt-l$_{1}$ norm, log1p-None, log1p-max, log1p-l$_{1}$ norm, & Uniform \\
\multicolumn{1}{c}{Input Scaling} & \begin{tabular}[c]{@{}c@{}}sqrt, sqrt-max,\\ sqrt-l$_{1}$ norm,\\ log1p, log1p-max,\\ log1p-l$_{1}$ norm\end{tabular} & Uniform \\
\end{tabular}
\end{table}
...
\multicolumn{1}{c}{Input Scaling} & \begin{tabular}[c]{@{}c@{}}sqrt, sqrt-max,\\sqrt-l$_{1}$ norm,\\ log1p-None, log1p-max,\\ log1p-l$_{1}$ norm\end{tabular} & Uniform \\
\end{tabular}
\end{table}
