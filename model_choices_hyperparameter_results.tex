...
source-detector height [cm] & 50, 75, 100, 125, 150 \\ 
source-detector distance [cm] & 50, 112.5, 175, 237.5, 300 \\ 
...
FWHM at  662 keV [\%] & 6.0, 6.5, 7.0, 7.5, 8.0, 8.5, 9.0 \\ 
...
Dropout Frequency & 0 - 1 & Uniform \\
Batch Size & 2$^{4}$ - 2$^{6}$ & Power of Two \\
