...
In this chapter we described how photons interact with detectors to create gamma-ray spectra, the theory behind ANNs, how to train ANNs, and the structure of the python package used in this dissertation. In the following section an ANN will be presented using these concepts and its performance on a number of real and simulated spectra will be discussed. 
