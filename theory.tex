...
\subsubsection{Compton Interaction}

Compton scattering and absorption is the interaction of a photon with an electron. as seen in Figure \ref{fig:compton_scatter}. This is the main energy deposition mechanism in the range of energies useful for gamma-ray spectroscopy. 

\begin{figure}[H]
\centering
\includegraphics[width=0.75\linewidth]{images/compton_scatter}
