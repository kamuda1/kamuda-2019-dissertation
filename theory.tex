...
In this section, the physics responsible for the features in gamma-ray spectra are described. 
...
When a photon with energy above 1022 keV interacts with the coulomb field of a nucleus, there is a probability that the photon will disappear and be replaced by an electron-positron pair. The positron will then annihilate with an electron in the medium, creating two 511 keV photons. This process is illustrated in Figure \ref{fig:pair_production}. Because one or both of these annihilation photons can escape the detector, they can produce single or double escape peaks in a gamma-ray spectrum. As seen in Figure \ref{fig:pair_production_spectra}, single escape peaks occur at 511 keV below the full-energy peak and double escape peaks occur at 1022 keV below this peak.
...
The energy resolution of a radiation detector describes how broad a photon's photopeak is in the detector's spectrum. The resolution is measured either in units of energy or as a percent of the peaks energy. The energy resolution of three scintillator (NaI(Tl), LaBr, CeBr) and two semiconductor radiation detectors are seen in Table \ref{table:detector_resolutions}. 
% pg 345 knoll
\begin{table}[H]
\centering
\begin{tabular}{|c|c|}
