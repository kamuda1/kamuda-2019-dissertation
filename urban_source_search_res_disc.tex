...
To see the generalization performance of the model to increased shielding, spectra were measured with different amounts of shielding. 


Figures \ref{fig:model_asymptotic_performance_co60} and \ref{fig:model_asymptotic_performance_
} show performance for isotopes with comparatively simplified spectra.
...
\begin{figure}[H]
    ...
    0.8 & \blackline & 1.0 & \blackdotline & 1.2 & \blackdashdotline
    \end{tabular}
        \caption{Shielding generalization performance in real Co$^{60}$ spectra for the DNN, CNN with and without autoencoder pretraining. F1 score shown in averaged over five networks trained with fixed-size datasets, The Figure on the right and left are trained using the simple and complete dataset.}
        \label{fig:generalization_cal_augdataset}
\end{figure}
...
\begin{figure}[H]
    ...
    0.8 & \blackline & 1.0 & \blackdotline & 1.2 & \blackdashdotline
    \end{tabular}
        \caption{Shielding generalization performance in real Cs$^{137}$ spectra for the DNN, CNN with and without autoencoder pretraining. F1 score shown in averaged over five networks trained with fixed-size datasets, The Figure on the right and left are trained using the simple and complete dataset.}
...
\begin{figure}[H]
    ...
    0.8 & \blackline & 1.0 & \blackdotline & 1.2 & \blackdashdotline
    \end{tabular}
        \caption{Shielding generalization performance in real Ba$^{133}$ spectra for the DNN, CNN with and without autoencoder pretraining. F1 score shown in averaged over five networks trained with fixed-size datasets, The Figure on the right and left are trained using the simple and complete dataset.}
...
\begin{figure}[H]
    ...
    0.8 & \blackline & 1.0 & \blackdotline & 1.2 & \blackdashdotline
    \end{tabular}
        \caption{Shielding generalization performance in real Eu$^{152}$ spectra for the DNN, CNN with and without autoencoder pretraining. F1 score shown in averaged over five networks trained with fixed-size datasets, The Figure on the right and left are trained using the simple and complete dataset.}
