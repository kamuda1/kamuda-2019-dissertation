...
\begin{table}[H]
	...
	\begin{tabular}{lllll}
		\hline
		Dataset & \multicolumn{4}{l}{\textbf{Simple}} \\
		Model & \textbf{CNN} & \textbf{DNN} & \textbf{CAE} & \textbf{DAE} \\ \hline
		Prediction & \textbf{$^{192}$Ir} & $^{177m}$Lu &  $^{75}$Se  & $^{67}$Ga \\
		Probability & \textbf{80} & 33 & 41 & 33 \\ \hline \\ \\
		
		\hline
		& \multicolumn{4}{l}{\textbf{Complete}} \\
...
$^{133}$Ba spectra measured at a signal-to-background ratio of 0.5 with a relative gain of 1.27 was replaced by recalibrated reference gain spectra.
...
Only the simple CAE with a source-to-background ratio of 1.0 alarmed after 120 s measurement time. 
