...
% Simple and complete DNN's, CNN's, CAE's, and DAE's were trained 
...
\begin{figure}[H]
     ...
     \end{subfigure}
        \caption{Calibration gain generalization performance in simulated spectra for the DNN, CNN with and without autoencoder pretraining.}
